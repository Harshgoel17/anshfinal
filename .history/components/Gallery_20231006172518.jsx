  ...
  return (
    <div className='h-[80vh] max-h-[80vh] flex gap-2'>
        <div className='grid grid-cols-3 gap-2 h-full  w-full flex-[2]  '>
            ...
            <div className='flex flex-col h-full w-full  gap-2'>
                <span className=' w-full h-full flex-1 overflow-hidden'>
                    <img src="/images/38.jpg" alt="" className='absolute '/>
                </span>
                
                <span className=' w-full h-full flex-[1.8] overflow-hidden'></span>
            </div>

            <div className='flex flex-col h-full w-full  gap-2'>
                <span className=' w-full h-full flex-[1.8] overflow-hidden'></span>
                <span className=' w-full h-full flex-1 overflow-hidden'></span>
