    ...
    <div className='flex h-24 w-screen items-center justify-between border-b px-10'>
        <div className='flex gap-7 items-center'>
            ...
            <div className='flex items-center justify-center gap-2'>
                <div className='rounded-full bg-foreground/10 px-5 py-[5px]'>All</div>
                <div className='rounded-full bg-foreground/10 px-5 py-[5px]'>Images</div>
                <div className='rounded-full bg-foreground/10 px-5 py-[5px]'>Videos</div>
                <div className='rounded-full bg-foreground/10 px-5 py-[5px]'>Memories</div>
            </div>
        </div>
