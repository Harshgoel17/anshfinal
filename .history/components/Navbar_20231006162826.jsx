    ...
    <div className='flex h-24 w-screen items-center justify-between border-b px-10'>
        <div className='flex gap-7 items-center'>
            ...
            <div className='flex items-center justify-center gap-2 text-sm'>
                ...
                <a href='/srisht/images' className='rounded-full bg-foreground/10 px-5 py-[5px] cursor-pointer'>Images</a>
                <a href='/srishti/videos' className='rounded-full bg-foreground/10 px-5 py-[5px] cursor-pointer'>Videos</a>
                <a href='/srishti/memories' className='rounded-full bg-foreground/10 px-5 py-[5px] cursor-pointer'>Memories</a>
            </div>
        </div>
