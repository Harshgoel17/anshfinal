...
const Navbar = () => {
  return (
    <div className='flex h-36 lg:h-24 w-screen items-center justify-between border-b px-2 lg:px-10'>
        <div className='lg:flex-row flex-col lg:flex gap-7 items-center'>
            ...
            <div className='flex items-center justify-center mt-10 gap-2 text-sm'>
