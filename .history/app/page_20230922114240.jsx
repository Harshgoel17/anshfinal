  ...
  return (
    <main className="h-screen w-full flex">
      ...
      <div className="h-full w-full flex flex-col items-center justify-center relative gap-8">
        <h1 className="font-monsterrat text-8xl font-bold tracking-wider">Gugulu</h1>
          ...
          <Button className="rounded-[5px] flex gap-2" type="submit">
            ...
            <Button className="rounded-[5px] flex gap-2 hover:bg-gradient-to-tr hover:from-violet-500 hover:to-indigo-500 group hover:text-white " type="submit">
