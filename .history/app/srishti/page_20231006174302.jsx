    ...
    <div className='overflow-x-hidden'>
        ...
        <div className='py-14 px-36 gap-5 flex flex-col'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <div className='bg-neutral-900 lg:w-[15vw] h-[28vh]  rounded-xl flex gap-1 overflow-hidden items-center justify-center text-center px-5 text-2xl relative'>
                    <p className='absolute text-lg top-5 left-5 font-semibold'>Age</p>
                    <p>
                    21 Years
                    </p>
                </div>
                
                <div className='bg-neutral-900 lg:w-[25vw] h-[28vh]  rounded-xl flex gap-1 overflow-hidden'>
                        <p></p>
                </div>
            </div>
