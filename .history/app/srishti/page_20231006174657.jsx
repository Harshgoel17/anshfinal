        ...
        <div className='py-14 px-36 gap-5 flex flex-col'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <div className='bg-neutral-900 lg:w-[25vw] h-[28vh]  rounded-xl flex gap-1 overflow-hidden items-center justify-center text-center px-5  relative'>
                        <p className='text-xl '><span className='italic text-2xl'>"You're the most beautiful thing that ever happened to me."</span>  <br /><span className='absolute bottom-6 left-[50%] translate-x-[-50%]'>
                        Ansh</span></p>
                </div>
            </div>
