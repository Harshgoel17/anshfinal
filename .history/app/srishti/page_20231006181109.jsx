    ...
    <div className='overflow-x-hidden'>
        ...
        <div className='py-8 lg:py-14 px-6 lg:px-36 gap-5 flex flex-col'>
            ...
            <div className='flex flex-col lg:flex-row items-center gap-4'>
                ...
                <div className='bg-neutral-900 lg:w-[15vw] lg:h-[28vh] h-[18vh]  rounded-xl flex gap-1 overflow-hidden items-center justify-center text-center px-5 text-3xl relative'>
