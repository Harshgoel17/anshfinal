  ...
  return (
    <main className="h-screen w-full flex">
      ...
      <div className="h-full w-full flex flex-col items-center justify-center relative gap-8">
        <h1 className="font-monsterrat lg:text-8xl font-bold tracking-wider text-7xl">Gugulu</h1>
          <input type="text" className="bg-background border border-foreground/20 rounded-full h-12 w-[80%] lg:w-[35%] px-5" value={'Who is my bestie?'}/>
